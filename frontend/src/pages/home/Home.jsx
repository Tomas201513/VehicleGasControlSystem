                            ...
                            >
                                <Box sx={{ mt: '10%' }}>
                                    <Typography sx={{
                                        ...
                                        variant="overline">
                                        Welcome to INSA Gas Station Management
                                    </Typography>
                                    <Typography sx={{
                                        fontSize: '0.9rem',
                                        color: "#9da4ae",
                                    ...
                                    <Typography sx={{
                                        ...
                                        color="text.secondary"
                                    >
                                        The app provides real-time updates on gas levels, making it easy to stay on top of inventory and prevent running out of fuel. You can also assign specific fueling stations to inBoxidual service cars, ensuring that each vehicle is getting the attention it needs.
                                    </Typography>
                                </Box>
                            </Grid>
                        </Grid>
